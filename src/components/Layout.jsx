...
const Layout = ({ children }) => {
  ...
  // Hide sidebar completely in performance mode
  const isPerformanceMode = location.pathname === '/performance' && location.search.includes('setlist=');
